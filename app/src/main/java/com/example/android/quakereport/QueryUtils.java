...
/**
    ...
    /**
        ...
        /**
         * Return a list of {@link EarthQuakeAL} objects that has been built up from
         * parsing a JSON response.
         */
        static ArrayList<EarthQuakeAL> extractEarthquakes() {

            // Create an empty ArrayList that we can start adding earthquakes to
            ArrayList<EarthQuakeAL> earthquakes = new ArrayList<>();
            ...
            try {
                ...
                for (int i = 0;i< features.length();i++){
                    ...
                    EarthQuakeAL earthquake = new EarthQuakeAL(mag, location, timeInMilliseconds,url);
